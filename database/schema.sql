...
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    weight FLOAT,
    bmi FLOAT,
    dietary_preference VARCHAR(20), -- vegetarian, vegan, jain, non-veg
    health_goal VARCHAR(20), -- weight_loss, weight_gain, maintenance, muscle_gain
...
CREATE TABLE IF NOT EXISTS food_items (
    ...
    category VARCHAR(50), -- street_food, main_course, snack
    meal_type VARCHAR(20), -- breakfast, lunch, dinner, snack
    region VARCHAR(50), -- mumbai, delhi, south, etc.
...
CREATE TABLE IF NOT EXISTS nutrition_info (
    ...
    serving_size VARCHAR(50), -- e.g., "1 piece", "1 plate"
...
CREATE TABLE IF NOT EXISTS predictions (
    ...
    portion_size VARCHAR(20), -- small, medium, large
...
CREATE TABLE IF NOT EXISTS achievements (
    ...
    criteria TEXT, -- JSON with achievement criteria
...
CREATE TABLE IF NOT EXISTS recommendations (
    ...
    reason VARCHAR(255), -- complementary, healthier_alternative, similar
    FOREIGN KEY (food_item_id) REFERENCES food_items(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS analytics (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    event_type VARCHAR(50), -- login, prediction, feedback, etc.
    user_id INTEGER,
